...
func TestTemplatesParseAndExecute(t *testing.T) {
	...
	cases := []struct {
		...
		{"home-domain", homeTmpl, homeData{Cfg: Config{ServerIP: "192.168.1.10", Domain: "home.example-lab.dev", LetsEncrypt: true},
			LE: true, Services: []serviceLink{{Name: "Vaultwarden", URL: "https://vault.home.example-lab.dev"}}}},
		{"letsencrypt", letsencryptTmpl, leData{Cfg: Config{ServerIP: "192.168.1.10", Domain: "home.example-lab.dev",
			LetsEncrypt: true, ACMEChallenge: "dns", DNSProvider: "cloudflare", ACMEEmail: "a@b.dev"},
			On: true, Msg: "ok", Providers: dnsProviders, HasToken: true, Running: false,
			Hosts: []certStatus{{Host: "home.example-lab.dev", URL: "https://home.example-lab.dev", OK: true, Issuer: "Let's Encrypt (R11)", Expires: "in 60 days"},
				{Host: "vault.home.example-lab.dev", URL: "https://vault.home.example-lab.dev", Note: "no certificate yet"}}}},
		{"letsencrypt-off", letsencryptTmpl, leData{Cfg: Config{ServerIP: "192.168.1.10"}, Providers: dnsProviders}},
